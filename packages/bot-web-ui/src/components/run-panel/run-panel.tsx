...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, ANALYSISTOOL, COPYTRADER, ANALYSISPAGE } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, ANALYSISTOOL, COPYTRADER, ANALYSISPAGE].includes(active_tab) || active_tour;
